...
$req = $mabase->prepare("INSERT INTO equipes(id, image, nom, fonction, description) VALUES(:id, :image, :nom, :fonction, :description)");
        $req->execute(array(
          "id" => "",
          "image" => $_POST['image'],
          "nom" => $_POST['nom'],
        ...
        header('Location: ajoutequipes.php');
        exit();
    }
?>
<body>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <form method='post' action='ajoutequipes.php'>
