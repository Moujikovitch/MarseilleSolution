<div id="milieu" class="pageevent">
	<div id="cont">
		<?php
			for ($i = 0 ; $i < 9 ; $i++)
			{
				echo "<div class='bgeventb'>
						<div class='ficheeventb'>
							<div class='fichephotoeventb'>
							</div>
							<div class='fichearticleeventb'>
								<div class='fichetitreeventb'>
									Titre de l'event
								</div>
								<div class='fichetexteeventb'>
